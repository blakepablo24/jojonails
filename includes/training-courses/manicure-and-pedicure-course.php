<div class="course-heading">
    <h1>Manicure & Pedicure Course</h1>
    <img src="images/training-courses-images/Nails-File.jpg" alt="">
</div>

<?php

$query = "SELECT * FROM course_training WHERE course_training_title = 'Manicure & Pedicure Course'";
