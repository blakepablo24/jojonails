<div class="course-heading">
    <h1>Massage Course</h1>
    <img src="images/training-courses-images/spray-tanning.jpg" alt="">
</div>

<?php

$query = "SELECT * FROM course_training WHERE course_training_title = 'Spray Tanning Course'";
