<div class="course-heading">
    <h1>Dermaplaning Course</h1>
    <img src="images/training-courses-images/dermaplaning-pic1.jpg" alt="">
</div>

<?php

$query = "SELECT * FROM course_training WHERE course_training_title = 'Dermaplaning Course'";
