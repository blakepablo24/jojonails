<div class="course-heading">
    <h1>Gel Polish Course</h1>
    <img src="images/training-courses-images/Red1.jpg" alt="">
</div>

<?php

$query = "SELECT * FROM course_training WHERE course_training_title = 'Gel Polish Course'";
