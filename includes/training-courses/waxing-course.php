<div class="course-heading">
    <h1>Waxing Course</h1>
    <img src="images/training-courses-images/Waxing-000011470615_Medium-300x200.jpg" alt="">
</div>

<?php

$query = "SELECT * FROM course_training WHERE course_training_title = 'Waxing Course'";
