<div class="course-heading">
    <h1>Acrylic Nail Course</h1>
    <img src="images/training-courses-images/imagee1-279x300.jpg" alt="">
</div>

<?php

$query = "SELECT * FROM course_training WHERE course_training_title = 'Acrylic Nail Course'";
...
<div class="main-section-training-course-background">
