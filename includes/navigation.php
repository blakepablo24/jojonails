    <!-- HEADER -->
    <header>
            <a href="index.php"><img src="images/front-page-images/jojos-nails-logo-drkr1.png" alt=""></a>
            <div class="header-large-screens">
                <h1>JoJo's Nails & Beauty</h1>
                <div class="header-large-screens-contact">
                    <h2><i class="far fa-envelope"></i>info@jojos.co.uk</h2>
                    <h2><i class="fas fa-phone-square"></i>07787406555</h2>
                </div>
            </div>
    </header>
        ...
        <!-- Nav-bar for small screens -->
            ...
            <div id="myNav" class="overlay">
                ...
                <div class="overlay-content">
                  ...
                  <a onclick="openNavMenuExt()">Training Courses <i class="fas fa-arrow-right"></i></a>
                  <a href="#">Certificates</a>
                  <a href="#">Reviews</a>
                  <a href="#">About</a>
                </div>
            </div>
                <div id="myNavExt" class="overlay-ext">
                    <a href="javascript:void(0)" class="closebtn" onclick="closeNavMenuExt()"><i class="fas fa-times"></i></a>
                    <div class="overlay-content-ext">
                        <a href="javascript:void(0)" onclick="openNav()"><i class="fas fa-arrow-left"></i> Training Courses:</i></a>
